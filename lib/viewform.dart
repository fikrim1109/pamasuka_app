  ...
  Future<void> _deleteForm(int surveyId) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && data['success'] == true) {
        ...
        setState(() {
          if (_forms.isNotEmpty && _currentIndex >= _forms.length) {
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          if (surveyId == null) {
                            ...
                            print("Edit button pressed but surveyId is null. Form data: $form");
                            return;
                          }

                          print("Navigating to EditFormPage with surveyId: $surveyId, formData: $form");
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          if (surveyId == null) {
                            ...
                            print("Delete button pressed but surveyId is null. Form data: $form");
                            return;
                          }
                          ...
                          if (confirm == true) {
                            print("Deleting survey with ID: $surveyId");
